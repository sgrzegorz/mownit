...
int main (void)
{
  ...
  int fd;
  fd = open("../data1.csv",O_WRONLY|O_CREAT|O_TRUNC,0644); //O_TRUNC removes whole content of file if it already exists
  ...
  printf("size,naive,blas\n");


  int sizes[] = {50,200,400,600,1000,1300};
